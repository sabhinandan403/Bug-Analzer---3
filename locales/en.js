...
module.exports = {
  ...
  wrike_id:'Wrike ID',
  task_name:'Task Name',
  label_review_category:'Review Category',
  placeholder_review_category: ' Select Review Category',
  label_project_name :'Project',
  heading_review_management:  'Review Management',
